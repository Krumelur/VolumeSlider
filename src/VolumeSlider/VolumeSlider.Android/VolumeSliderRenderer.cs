...
using VolumeSlider.Forms.Plugin.Droid;
using Xamarin.Forms;
using Xamarin.Forms.Platform.Android;
using Color = Xamarin.Forms.Color;
using VolumeSlider.Forms.Plugin.Shared;
using Android.Media;

[assembly: ExportRenderer(typeof(VolumeSelector), typeof(VolumeSelectorRenderer))]
...
namespace VolumeSlider.Forms.Plugin.Droid
{
	...
	/// </summary>
	public class VolumeSelectorRenderer : ViewRenderer<VolumeSelector, SeekBar>, SeekBar.IOnSeekBarChangeListener
	{
		...
		public VolumeSelectorRenderer(Context context) : base(context)
		{
			AutoPackage = false;
		}
		...
		protected override void OnElementChanged(ElementChangedEventArgs<VolumeSelector> e)
		{
			...
			VolumeSelector slider = e.NewElement;
		...
		protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
		{
			...
			VolumeSelector view = Element;
			if(e.PropertyName == VolumeSelector.VolumeProperty.PropertyName && NormalizedVolume != view.Volume)
			{ 
